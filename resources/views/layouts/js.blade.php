...
<script>
    ...
    if (document.getElementsByClassName('editor').length > 0) {
        tinymce.init({
            ...
            toolbar: 'template',
            templates: [
                {title: 'Partner With Us Button', description: 'Partner With Us', content: '<a href="#" class="general-btn">Partner With Us</a>'},
                {title: 'Learn More Button', description: 'Learn More', content: '<a href="#" class="general-btn vice-versa">Learn More</a>'}
            ]
        });
    }
