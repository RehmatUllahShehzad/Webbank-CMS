                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route(config('core.routeNamePrefix').'settings.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Site Logo Full
                                    </label>
                                    <div class="col-md-6">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Site Logo Small 
                                    </label>
                                    <div class="col-md-6">
                                        <input type="file" accept="image/*" class="form-control" value="{{ old('site_logo_small',getGeneralSetting('site_logo_small')) }}" name="site_logo_small" placeholder="Site Logo Small">
                                        @error('site_logo_small')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                        @if (getGeneralSetting('site_logo_small'))
                                            <img src="{{ getGeneralSetting('site_logo_small') }}" style="width: 100px; height: 100px;" alt="{{ getGeneralSetting('site_title') }}">
                                        @endif
                                    </div>
                                </div>
                                <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{ old('phone',getGeneralSetting('phone')) }}" name="phone" placeholder="phone number">
                                        @error('phone')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right"> Timing
                                    </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{ old('timing',getGeneralSetting('timing')) }}" name="timing" placeholder="timing">
                                        @error('timing')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <h5 class="mt-4">Alert Box Settings</h5>
                                <hr>

                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Alert Box Title
                                    </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{ old('alert_title',getGeneralSetting('alert_title')) }}" name="alert_title" placeholder="Alert Box Title">
                                        @error('alert_title')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <hr>
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Specialty Finance Email
                                    </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{ old('specialty_finance_email',getGeneralSetting('specialty_finance_email')) }}" name="specialty_finance_email" placeholder="Specialty Finance email">
                                        @error('specialty_finance_email')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                </div>
                                <hr>
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Become Partner Email
                                    </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{ old('become_partner_email',getGeneralSetting('become_partner_email')) }}" name="become_partner_email" placeholder="Become Partner email">
                                        @error('become_partner_email')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                </div>
